...
* Operating System: Windows 10 / Windows 11 (desktop environment used by the store employees).
...
* Documentation & Test Cases: Markdown (.md), Excel (.xlsx).

* Test Runs & Bug Reporting: 
...
* No dedicated test server is available; testing is performed on the live system.

* Test data will be limited, to avoid interfering with daily operations.

* Mobile testing is out of scope, therefore mobile devices will not be included in the environment setup.